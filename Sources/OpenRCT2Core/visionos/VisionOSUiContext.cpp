...
#else
static std::string GetVisionOSBundlePath() { return "."; }
static std::string GetVisionOSDocumentsPath() { return "."; }
static bool FileExistsAt(const std::string&) { return false; }
#endif
    ...
    namespace Ui
    {
        ...
        public:
            ...
            int32_t ShowMenuDialog(
                const std::vector<std::string>& options, const std::string&, const std::string&) override
            {
            ...
            const std::string& GetDocumentsPath() const { return _documentsPath; }
        };
