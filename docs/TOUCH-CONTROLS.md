...
| Text field without hardware keyboard attached | Native light iPadOS keyboard | A hidden UIKit first responder forwards native text and editing keys into OpenRCT2's text-composition path. |
