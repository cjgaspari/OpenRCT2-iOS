...
- **Entitlements File**: `Config/OpenRCT2iOS.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/OpenRCT2iOS.entitlements`:
