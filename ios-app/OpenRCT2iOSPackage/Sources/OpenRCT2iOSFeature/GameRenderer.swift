...
// Inline Metal shader source (compiled at runtime)
...
public final class GameRenderer: NSObject, MTKViewDelegate {
    ...
    public init?(metalView: MTKView) {
        ...
        print("OpenRCT2 iOS renderer initialized successfully!")
    }
